  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <p>If you want to chat, feel free to reach out anytime!</p>
        </div>
      {/* Social Media Card */}
        <div className="p-6 bg-white border border-gray-200 rounded-lg shadow hover:shadow-md transition-shadow max-w-md mx-auto">
        <h3 className="text-2xl font-semibold text-gray-900 mb-6 text-center">Social Media</h3>
        <div className="flex justify-center space-x-8 bg-gray-100 shadow rounded-lg px-8 py-4 text-3xl text-gray-600">
            ...
            <a
                ...
                className="flex items-center justify-center w-14 h-14 rounded-full bg-white hover:bg-black hover:text-white transition-colors shadow-md"
            >
                {icon}
            </a>
            ))}
